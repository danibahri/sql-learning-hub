...
select * from masukD where jumlah = 5

	declare @KOdebarang char(5), @jumlah int, @Nomor char(3) -- variable
	declare crIns cursor for select Nomor, KOdebarang, Jumlah from masukD where jumlah = 5
	open crIns
	fetch next from crIns into @KOdebarang, @NOmor, @jumlah
	while (@@fetch_status = 0) begin
	...
	declare @KOdebarang char(5), @jumlah int, @Barang char(10) -- variable
